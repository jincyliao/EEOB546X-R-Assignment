...
---
```{r}
setwd("/Users/user/EEOB546X-R-Assignment")
```
#Part I
...
```
**3. Sort the dataframe using Group and Species_ID values. **
```{r}
...
**6. Build a new dataframe with all counting values per Sample_ID and melt the results.**
```{r}
